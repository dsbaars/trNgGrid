...
(function (TrNgGrid) {
    ...
    */
    ...
    var GridController = (function () {
        function GridController($compile, $parse, $timeout, $interpolate, $templateCache) {
    ...
    function configureTemplates($templateCache, $interpolate) {
        ...
        if (!$templateCache.get(TrNgGrid.cellHeaderTemplateId)) {
            $templateCache.put(TrNgGrid.cellHeaderTemplateId, '<div class="' + TrNgGrid.headerCellCssClass + '" ng-switch="isCustomized">' + '  <div ng-switch-when="true">' + '    <div ng-transclude=""></div>' + '  </div>' + '  <div ng-switch-default>' + '    <div class="' + TrNgGrid.columnTitleCssClass + '">' + '      ' + $interpolate.startSymbol() + 'columnTitle |' + TrNgGrid.translateFilter + ':gridOptions.locale' + $interpolate.endSymbol() + '' + '       <div ' + TrNgGrid.columnSortDirectiveAttribute + '=""></div>' + '    </div>' + '    <div ' + TrNgGrid.columnFilterDirectiveAttribute + '=""></div>' + '  </div>' + '</div>');
        }
        if (!$templateCache.get(TrNgGrid.cellBodyTemplateId)) {
            $templateCache.put(TrNgGrid.cellBodyTemplateId, '<div ng-attr-class="' + TrNgGrid.bodyCellCssClass + ' text-' + $interpolate.startSymbol() + 'columnOptions.displayAlign' + $interpolate.endSymbol() + '" ng-switch="isCustomized">' + '  <div ng-switch-when="true">' + '    <div ng-transclude=""></div>' + '  </div>' + '  <div ng-switch-default>' + $interpolate.startSymbol() + 'gridDisplayItem[columnOptions.displayFieldName]' + $interpolate.endSymbol() + '</div>' + '</div>');
        }
        ...
        if (!$templateCache.get(TrNgGrid.footerGlobalFilterTemplateId)) {
            $templateCache.put(TrNgGrid.footerGlobalFilterTemplateId, '<span ng-show="gridOptions.enableFiltering" class="pull-left form-group">' + '  <input class="form-control" type="text" ng-model="gridOptions.filterBy" ng-keypress="speedUpAsyncDataRetrieval($event)" ng-attr-placeholder="' + $interpolate.startSymbol() + '\'Search\'|' + TrNgGrid.translateFilter + ':gridOptions.locale' + $interpolate.endSymbol() + '"></input>' + '</span>');
        }
        if (!$templateCache.get(TrNgGrid.footerPagerTemplateId)) {
            $templateCache.put(TrNgGrid.footerPagerTemplateId, '<span class="pull-right form-group">' + ' <ul class="pagination">' + '   <li ng-class="{disabled:!pageCanGoBack}" ng-if="extendedControlsActive">' + '     <a href="" ng-click="pageCanGoBack&&navigateToPage(0)" ng-attr-title="' + $interpolate.startSymbol() + '\'First Page\'|' + TrNgGrid.translateFilter + ':gridOptions.locale' + $interpolate.endSymbol() + '">' + '         <span>&laquo;</span>' + '     </a>' + '   </li>' + '   <li ng-class="{disabled:!pageCanGoBack}" ng-if="extendedControlsActive">' + '     <a href="" ng-click="pageCanGoBack&&navigateToPage(gridOptions.currentPage - 1)" ng-attr-title="' + $interpolate.startSymbol() + '\'Previous Page\'|' + TrNgGrid.translateFilter + ':gridOptions.locale' + $interpolate.endSymbol() + '">' + '         <span>&lsaquo;</span>' + '     </a>' + '   </li>' + '   <li ng-if="pageSelectionActive" ng-repeat="pageIndex in pageIndexes track by $index" ng-class="{disabled:pageIndex===null, active:pageIndex===gridOptions.currentPage}">' + '      <span ng-if="pageIndex===null">...</span>' + '      <a href="" ng-click="navigateToPage(pageIndex)" ng-if="pageIndex!==null" ng-attr-title="' + $interpolate.startSymbol() + '\'Page\'|' + TrNgGrid.translateFilter + ':gridOptions.locale' + $interpolate.endSymbol() + '">' + $interpolate.startSymbol() + 'pageIndex+1' + $interpolate.endSymbol() + '</a>' + '   </li>' + '   <li ng-class="{disabled:!pageCanGoForward}" ng-if="extendedControlsActive">' + '     <a href="" ng-click="pageCanGoForward&&navigateToPage(gridOptions.currentPage + 1)" ng-attr-title="' + $interpolate.startSymbol() + '\'Next Page\'|' + TrNgGrid.translateFilter + ':gridOptions.locale' + $interpolate.endSymbol() + '">' + '         <span>&rsaquo;</span>' + '     </a>' + '   </li>' + '   <li ng-class="{disabled:!pageCanGoForward}" ng-if="extendedControlsActive">' + '     <a href="" ng-click="pageCanGoForward&&navigateToPage(lastPageIndex)" ng-attr-title="' + $interpolate.startSymbol() + '\'Last Page\'|' + TrNgGrid.translateFilter + ':gridOptions.locale' + $interpolate.endSymbol() + '">' + '         <span>&raquo;</span>' + '     </a>' + '   </li>' + '   <li class="disabled" style="white-space: nowrap;">' + '     <span ng-hide="totalItemsCount">' + $interpolate.startSymbol() + '\'No items to display\'|' + TrNgGrid.translateFilter + ':gridOptions.locale' + $interpolate.endSymbol() + '</span>' + '     <span ng-show="totalItemsCount" ng-attr-title="' + $interpolate.startSymbol() + '\'Select Page\'|' + TrNgGrid.translateFilter + ':gridOptions.locale' + $interpolate.endSymbol() + '">' + '       ' + $interpolate.startSymbol() + 'startItemIndex+1' + $interpolate.endSymbol() + ' - ' + $interpolate.startSymbol() + 'endItemIndex+1' + $interpolate.endSymbol() + ' ' + $interpolate.startSymbol() + '\'displayed\'|' + TrNgGrid.translateFilter + ':gridOptions.locale' + $interpolate.endSymbol() + '' + '       <span>, ' + $interpolate.startSymbol() + 'totalItemsCount' + $interpolate.endSymbol() + ' ' + $interpolate.startSymbol() + '\'in total\'|' + TrNgGrid.translateFilter + ':gridOptions.locale' + $interpolate.endSymbol() + '</span>' + '     </span > ' + '   </li>' + ' </ul>' + '</span>');
        }
    }
})(TrNgGrid || (TrNgGrid = {}));
